...
/**
 * 03-frontend.md apps/rider "하단 탭: 콜/운행/정산/마이". TabBar(packages/ui) 재사용.
 * 탭 이동은 이 컴포넌트가 useNavigate로 처리(TabBar 자체는 라우팅에 의존하지 않음).
 */
const TABS = [
  { key: "calls", label: "콜", path: "/" },
  { key: "active", label: "운행", path: "/active" },
  { key: "earnings", label: "정산", path: "/earnings" },
