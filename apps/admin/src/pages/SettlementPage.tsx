...
/**
 * 08 G7-①: /settlement → "정산" 재편(07 F10의 쿠폰 매출·결제 UI 제거 — 쿠폰 모델 폐기).
 ...
 *  + CSV 내보내기(출금 큐/포인트 원장 — BOM 포함, 06 E10-③).
 */
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-gray-500">출금 신청을 처리하고 포인트·지급 흐름을 감사해요.</p>
      </div>
