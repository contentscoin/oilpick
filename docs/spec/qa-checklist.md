...
## 10. N2 희망시간 개편·N5 요청정보 노출 (2026-08-05)

| 플로우 | 정상 | 예외 케이스 | 상태 |
|---|---|---|---|
| 희망시간 지정(U5, N2) | datetime-local 상시 노출(기본 = 현재 15분 올림) + [지금 바로] → `'YYYY-MM-DD HH:mm'` 저장 | 필수·과거(현재−30분 이전) 거부(step next·제출 양쪽), "지금" 리터럴 신규 저장 폐기 | ✅ [단위] |
