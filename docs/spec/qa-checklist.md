...
| 도로 경로·ETA(R3/R4, L3) | 콜 상세 "도로 기준" 칩 + 운행 지도 경로선 | 위치 거부·KAKAO 키 미설정 → 미표기 폴백 🔴 실 키 실측(11) | ✅ [단위 — 폴백 경로] |
...
| 내 정산 카드(R7, L9) | 이번 달 포인트 지급분+일별 접이식+정산 완료 푸시 | 지갑 오해 차단 카피, 타 라이더 0건 | ✅ [단위 2 + pgTAP 6] |
